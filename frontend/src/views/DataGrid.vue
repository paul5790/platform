...
const headerName = ref(["UTC_key","MESSAGEID","MCOURSEOVERGROUNDDEGREESMAGNETIC","MODEINDICATOR","SPEEDOVERGROUNDKNOTS",
"NSPEEDOVERGROUNDKNOTS","CHECKSUM","COURSEOVERGROUNDDEGREESMAGNETIC","SPEEDOVERGROUNDKMPERHOUR","KSPEEDOVERGROUNDKMPERHOUR",
"TCOURSEOVERGROUNDDEGREESTRUE","COURSEOVERGROUNDDEGREESTRUE"]);
const dataSet = ref([]); // 빈 배열로 초기화


try {
  axios
    .post("http://192.168.0.73:8097/data/vtg")
    .then((response) => {
